...
HS_PORT=${ONION_PORT:-"80"}

echo "---------------------------------------------------"
echo "Starting Sapphive Onion Sidecar"
echo "Targeting service: $TARGET_HOST"
echo "Exposing on .onion port: $HS_PORT"
echo "---------------------------------------------------"
...
HiddenServicePort $HS_PORT $TARGET_HOST
EOF
...
show_hostname() {
    ...
    echo "***************************************************"
    echo " YOUR ONION ADDRESS: $(cat $hostname_file)"
    echo "***************************************************"
}
